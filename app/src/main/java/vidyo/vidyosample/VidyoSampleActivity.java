...
import com.example.administrator.vidyo.R;
...
import vidyo.LmiDeviceManager.LmiDeviceManagerView;
import vidyo.LmiDeviceManager.LmiVideoCapturer;
  ...
  private void setupAudio() {
	...
	protected Dialog onCreateDialog(int id) {
		if (id == DIALOG_LOGIN) {
			...
			String portalInfoArray[] = { "vimal.sandboxga.vidyo.com", "vimal3", "vimal3" };
